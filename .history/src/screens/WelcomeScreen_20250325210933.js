  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        console.log('Signup successful, navigating to onboarding with user ID:', data?.user?.id);
        
        // Store the user ID in a variable to make sure it exists
        ...
        setTimeout(() => {
          ...
          if (userId) {
            // Use push instead of navigate to create a new screen instance
            ...
            Alert.alert(
              ...
              'Dein Konto wurde erstellt, aber es gab ein Problem. Bitte starte die App neu und melde dich an.'
            );
          }
        }, 500);
      }
