              ...
              try {
                ...
                if (magicLinkError) {
                  ...
                  if (isRateLimitError) {
                    ...
                    console.log('Rate limit hit for magic link');
                    Alert.alert(
                      'Konto erfolgreich erstellt',
                      'Dein Konto wurde erstellt und deine Präferenzen gespeichert. Du hast bereits eine E-Mail erhalten. Bitte prüfe deinen Posteingang und verwende den Link in der E-Mail, um dich anzumelden.',
                      [{ 
                        text: 'Verstanden', 
                        onPress: () => {
