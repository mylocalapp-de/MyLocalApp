...
const isSmallScreen = width < 1281 || height < 721;
...
const CalendarScreen = () => {
  ...
  const calendarHeight = isSmallScreen ? height * 0.32 : height * 0.22;
  const calendarFixedHeight = Math.min(320, calendarHeight);
