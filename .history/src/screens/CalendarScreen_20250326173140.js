...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, SafeAreaView, Dimensions, Platform, ScrollView } from 'react-native';
...
const CalendarScreen = () => {
  ...
  // Fixed calendar height based on device size - ensure all days fit
  const calendarFixedHeight = isSmallScreen ? 350 : 380;
