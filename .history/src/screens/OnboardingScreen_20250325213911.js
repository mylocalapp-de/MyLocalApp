      ...
      if (userId) {
        try {
          ...
          if (rpcError) {
            ...
            // Don't try to automatically authenticate - just complete the onboarding process
            if (userId && userEmail) {
              console.log('Completing onboarding for new user:', userEmail);
              
              // Simply show a success message and return to welcome screen
              Alert.alert(
                'Konto erfolgreich eingerichtet',
                'Dein Konto wurde erstellt und deine Präferenzen gespeichert. Du kannst dich jetzt mit deiner E-Mail-Adresse anmelden.',
                [{ 
                  text: 'Zur Anmeldung', 
                  onPress: () => {
