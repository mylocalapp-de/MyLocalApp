...
const OnboardingScreen = ({ navigation, route }) => {
  ...
  const { setPreferences, user, createProfile, refreshAuthState } = useAuth();
  ...
  const navigateToMainApp = () => {
    // Navigate to the redirect screen that will handle the auth state refresh and navigation reset
    console.log('Navigating to RedirectToMain screen');
    navigation.replace('RedirectToMain');
  };
