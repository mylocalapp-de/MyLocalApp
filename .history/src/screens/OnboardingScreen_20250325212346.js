...
const OnboardingScreen = ({ navigation, route }) => {
  ...
  // Function to safely navigate to main app
  const navigateToMainApp = () => {
    try {
      // First try using CommonActions
      setTimeout(() => {
        try {
          navigation.dispatch(
            CommonActions.reset({
          ...
          console.log('Navigation reset failed, trying alternative:', navError);
          
          // If that fails, try checking the parent navigator
          try {
            // Try navigating to Auth first to ensure we're at the right level
            ...
            console.log('Parent navigation also failed:', parentError);
      ...
      Alert.alert('Navigation Error', 'Could not navigate to main app. Please restart the app.');
    }
  };
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Success - navigate to main app using CommonActions with a short delay
        navigateToMainApp();
      }
    } catch (error) {
