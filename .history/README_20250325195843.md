...
- Three distinct chat types:
  1. **Open Groups**: Anyone can write and read messages
  2. **Broadcast Channels**: Users can only read, react with emojis, and comment on posts by the channel owner
  3. **AI Assistant**: Direct messaging with the village AI assistant "Dorfbot"
- Navigation uses Stack Navigator for proper screen flow
- Each chat type has its own specific UI and interaction patterns

## Article System Implementation

- Full article view with extended content display
- Interactive features:
  - Emoji reactions system
  - Comments section with user attribution
  - Time-stamped comments and reactions
- Navigation handled through Stack Navigator
